...
function init(){
 ...
 const circlestyle = new ol.style.Circle({
  ...
  map.addLayer(baseLayerGroup); //openstreetMap
    ...
    const baseLayerElements= document.querySelector('#slider');
    baseLayerElements.addEventListener('change',function(){
     
      var selval = parseInt(this.value);
      var lys =  baseLayerGroup.getLayers() ;
      
      console.log(selval,typeof(selval))
      switch(selval) {
        case 0:
           lys.item(0).setVisible(true);
           lys.item(1).setVisible(false);
           lys.item(2).setVisible(false);
          // code block
          break;
       ...
       case 5:
          lys.item(0).setVisible(true);
          lys.item(1).setVisible(true);
           lys.item(1).setOpacity(1)
          lys.item(2).setVisible(true);
          // code block
          break; 
        ...
        default:
          ...
          lys.item(0).setVisible(true);
          lys.item(1).setVisible(true);
          lys.item(1).setOpacity(selval/5.0)
          lys.item(2).setVisible(true);
